...
|
*/
$config['base_url'] = 'http://localhost/OneNorthShip';
...
|
*/
$config['encryption_key'] = 'g4KL2s8d9JfwE7h38fJf8W9kdLm23Plk';
...
$config['sess_save_path'] = sys_get_temp_dir(); // or use APPPATH.'cache/sessions'
